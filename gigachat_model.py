...
def responce_to_litellm_format(response):
        ...
        model_response = ModelResponse(
            ...
            model=f"gigachat/{response.model}",  # TODO
    ...
    def completion(self, *args, **kwargs) -> litellm.ModelResponse:
        ...
        while i < max_retries:
            try:
                ...
                print(type(e), e)
                print(function_call_json["messages"])
                time.sleep(5)
            i += 1

        model_response = responce_to_litellm_format(response)
        return model_response
...
litellm.model_cost["gigachat/GigaChat:2.0.28.02"] = {
